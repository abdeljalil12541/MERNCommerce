  ...
  return (
    <div className="w-full bg-white">
        ...
        <div className='w-full px-4 grid grid-cols-4 mb-5'>
            <div className='col-span-1 CardHover relative mx-2 cursor-pointer'>
                <HoverImage
                    src="https://mrbeast.store/cdn/shop/files/MB0121-PNK_0006_SBpinkdeckpanther.jpg"
                    hoverSrc="https://mrbeast.store/cdn/shop/files/MB0121-PNK_0002_SBpinkdecktop.jpg?v=1721252530&width=493"
                    className="rounded"
                />
                <span className="absolute top-2 left-2 bg-[#1AACDD] text-white text-[10px] me-2 px-4 py-1 rounded-xl font-semibold">NEW</span>
